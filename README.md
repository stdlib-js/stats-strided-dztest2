...
```javascript
import dztest2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dztest2@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-strided-dztest2/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-dztest2/actions/workflows/test.yml?query=branch:v0.1.0
